...
export default function ActivityDetailsModal({
  ...
  const handleShowRoute = () => {
    if (activity) {
      ...
      if (activity.status === "done") {
        Alert.alert("Task Completed", "This task has already been completed. No route navigation available.", [
          { text: "OK" },
        ]);
      ...
      if (result.success) {
        ...
        if (onNavigateToMap) {
          onNavigateToMap(
            ...
            getBinCoordinates(activity.bin_location, activity.bin_id),
  ...
  return (
    <>
        ...
        <View style={styles.container}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.infoCard}>
                ...
                <View style={styles.infoRow}>
                  ...
                  <Text style={[styles.infoValue, { color: getFillLevelColor(activity.bin_level) }]}>
                    {activity.bin_level}%
                  </Text>
                </View>
                ...
                <View style={styles.infoRow}>
                  ...
                  <Text style={[styles.infoValue, { color: getPriorityColor(activity.priority) }]}>
                    {activity.priority.charAt(0).toUpperCase() + activity.priority.slice(1).toLowerCase()}
                  </Text>
                </View>
                ...
                <View style={styles.infoRow}>
                  ...
                  <Text style={[styles.infoValue, { color: getBadgeStyle(activity.status).backgroundColor }]}>
            ...
            <View style={styles.section}>
              <View style={styles.mapSectionHeader}>
                ...
                <View
                  style={[
                    ...
                    {
                      backgroundColor:
                        binData && isGPSValid() ? "#4caf50" : binData && binData.backup_latitude ? "#ff9800" : "#666",
                    },
                  ]}
                >
              ...
              <View style={styles.mapCard}>
                  ...
                  >
                    ...
                    >
                      <View style={styles.cleanMarker}>
                        <View
                          style={[
                            styles.cleanMarkerCircle,

                            {
                              backgroundColor:
                                activity.bin_level > 80 ? "#f44336" : activity.bin_level > 50 ? "#ff9800" : "#4caf50",
                            },
                          ]}
                        >
                ...
                <View style={styles.mapActions}>
                  <TouchableOpacity
                    style={[styles.mapActionButton, activity.status === "done" && styles.mapActionButtonDisabled]}
                    onPress={handleShowRoute}
                    disabled={activity.status === "done"}
                  >
                    <Text style={[styles.mapActionText, activity.status === "done" && styles.mapActionTextDisabled]}>
                  ...
                  <TouchableOpacity style={styles.mapActionButton} onPress={() => setShowVoiceSettings(true)}>
              ...
              <View style={styles.section}>
                ...
                <View style={styles.inputGroup}>
                  ...
                  <View style={styles.readOnlyContainer}>
                    <Text style={styles.readOnlyText}>{activity.bin_location}</Text>
                  </View>
                </View>
                ...
                <View style={styles.inputGroup}>
                  ...
                  <View style={styles.readOnlyContainer}>
                    <Text style={styles.readOnlyText}>
                      Bin ID: {activity.bin_id.charAt(0).toUpperCase() + activity.bin_id.slice(1).toLowerCase()} • Fill
                ...
                <TouchableOpacity style={styles.routeButton} onPress={handleShowRoute}>
                  <Text style={styles.routeButtonText}>Show Route to Bin</Text>
                </TouchableOpacity>
              ...
              <View style={styles.section}>
                ...
                {activity.bin_condition && (
                  <View style={styles.inputGroup}>
                    ...
                    <View style={styles.readOnlyContainer}>
                      <Text style={styles.readOnlyText}>{activity.bin_condition.replace("_", " ").toUpperCase()}</Text>
                    </View>
                  </View>
                )}
                ...
                {activity.collection_time && (
                  <View style={styles.inputGroup}>
                    ...
                    <View style={styles.readOnlyContainer}>
                      <Text style={styles.readOnlyText}>{formatActivityTime(activity.collection_time)}</Text>
                    </View>
                  </View>
                )}
              </View>
                ...
                <View style={styles.inputGroup}>
                  ...
                  <View style={styles.conditionButtons}>
                    {(["good", "damaged", "needs_repair"] as const).map((condition) => (
                      <TouchableOpacity
                        key={condition}
                        style={[styles.conditionButton, binCondition === condition && styles.conditionButtonActive]}
          ...
          <View style={styles.footer}>
            {activity.status === "pending" ? (
              ...
              <TouchableOpacity style={[styles.actionButton, styles.closeButtonFull]} onPress={onClose}>
      ...
      <VoiceSettingsModal visible={showVoiceSettings} onClose={() => setShowVoiceSettings(false)} />
    </>
  );
}
